function [ ConfigFileName] = Configuration(rand_flag, IsObjVideo, debug_mode, output_directory, obj1_mean, obj1_sd, obj2_mean, obj2_sd)
%% Create structs
...
StatisticsConfig.MEAN_NOF_BACKGROUND = 1000; %mean no of frame for BG grain for normanl distribution
...
VideoConfig.NAME = sprintf('%s/%s__obj1_%.1f_%.2f__obj2_%.1f_%.2f__%dHz_%dsec__bg_%.1f_%.2f.avi', ...
    output_directory,...
    figure_str,...
    ...
    FrameConfig.FPS, FrameConfig.NUMBER_OF_FRAMES / FrameConfig.FPS,...
