...
StatisticsConfig.MEAN_NOF_BACKGROUND = 250; %mean no of frame for BG grain for normanl distribution
...
VideoConfig.NAME = sprintf('%s/%s__obj1_%.1f_%.1f__obj2_%.1f_%.1f__%dHz_%dsec__bg_%.1f_%.1f.avi', ...
    output_directory,...
    figure_str,...
